...
### Changed
- Bumped minimum SDK constraint to Dart 3.11.0 and Flutter 3.41.0
- Updated `device_info_plus` to ^13.0.0
- Updated `package_info_plus` to ^10.0.0
- Changed license from LGPL-3 to MIT

## [0.5.3] - 2026-04-13

### Fixed
- Compatibility with WASM by changing dart html library to js_interop

### Fixed
- Fixed linting issues with `use_null_aware_elements` rule for compatibility with `lints 6.1.0`
- Updated null-safe map literal syntax to use `?` operator for optional values
